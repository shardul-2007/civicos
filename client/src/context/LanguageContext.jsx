...
export const TRANSLATIONS = {
  en: {
    ...
    reportDescTitle: "Describe the Issue",
    reportDescSub: "Our AI Engine analyzes your description to determine department routing & priority.",
    issueTitleLabel: "Issue Title",
    issueTitlePlace: "e.g. Water Main Leak Near College Bus Stop",
    descLabel: "Detailed Description",
    descPlace: "Describe the defect, severity, hazard level, or relevant landmarks...",
    catLabel: "Category",
    autoDetectCategory: "Auto-Detect by AI",
    ...
    locationSub: "Use GPS, search any road/landmark/city across India, click the map, or drag the pin to pinpoint the exact issue location.",
    whoAreYou: "Who are you?",
    contactSub: "Anonymous submissions are accepted. Contact info helps us send you resolution alerts.",
    fullName: "Full Name",
    phone: "Phone",
    email: "Email",
    confirmReportTitle: "Confirm your report",
    reviewNotice: "After submission, you'll receive a Municipal Tracking Code (e.g. CIV-XXXXXX-XXXX) to monitor real-time resolution progress.",
  ...
  hi: {
    ...
    reportDescSub: "हमारी एआई प्रणाली आपके विवरण का विश्लेषण करके सही विभाग और प्राथमिकता तय करती है।",
    issueTitleLabel: "समस्या का शीर्षक",
    issueTitlePlace: "उदा. कॉलेज बस स्टॉप के पास मुख्य पाइपलाइन गळती",
    descLabel: "विस्तृत विवरण",
    descPlace: "दोष, गंभीरता, संभावित खतरे या आसपास के मुख्य स्थानों का विवरण दें...",
    catLabel: "श्रेणी चुनें",
    autoDetectCategory: "एआई द्वारा स्वतः पहचानें",
    wardLabel: "वार्ड नंबर",
    wardLabelPrefix: "वार्ड",
    attachPhoto: "फोटो प्रमाण जोड़ें (वैकल्पिक)",
    uploadPhoto: "फोटो अपलोड करें",
    imageAttached: "✔ फोटो संलग्न किया गया",
    whereIsProblem: "समस्या का सटीक स्थान कहाँ है?",
    locationSub: "जीपीएस का उपयोग करें, भारत में किसी भी सड़क/शहर की खोज करें, मानचित्र पर क्लिक करें या पिन खींचें।",
    whoAreYou: "आपकी जानकारी",
    contactSub: "अनामित रिपोर्ट स्वीकार्य हैं। संपर्क जानकारी से आपको अपडेट मिलते हैं।",
    fullName: "पूरा नाम",
    phone: "फोन नंबर",
    email: "ईमेल पता",
    confirmReportTitle: "अपनी रिपोर्ट की पुष्टि करें",
    reviewNotice: "जमा करने के बाद, आपको रियल-टाइम प्रगति देखने के लिए नगर निगम ट्रैकिंग कोड मिलेगा।",
    ...
    catDrainage: "नाली निकासी",
    catGarbage: "कचरा",
    catStreetlight: "स्ट्रीटलाइट",
    catPublicSafety: "सार्वजनिक सुरक्षा",
    catPothole: "सड़क का खड्डा",
    catSewage: "सीवरेज",
    catTreeParks: "पेड़/पार्क",
    catOther: "अन्य",
  ...
  mr: {
    ...
    reportDescTitle: "समस्येचे वर्णन करा",
    reportDescSub: "आमची AI प्रणाली तुमच्या समस्येचे विश्लेषण करून योग्य विभाग आणि प्राधान्यक्रम निश्चित करते.",
    issueTitleLabel: "समस्येचे शीर्षक",
    issueTitlePlace: "उदा. महाविद्यालयाच्या बस थांब्याजवळ पाण्याची मुख्य पाइपलाइन गळती",
    descLabel: "सविस्तर वर्णन",
    descPlace: "दोष, तीव्रता, संभाव्य धोका किंवा जवळील महत्त्वाच्या ठिकाणांचे वर्णन करा...",
    catLabel: "वर्ग",
    autoDetectCategory: "AI द्वारे आपोआप शोधा",
    wardLabel: "प्रभाग क्रमांक",
    wardLabelPrefix: "प्रभाग",
    attachPhoto: "फोटो पुरावा जोडा (ऐच्छिक)",
    uploadPhoto: "फोटो अपलोड करा",
    imageAttached: "✔ फोटो जोडला गेला",
    whereIsProblem: "समस्या कुठे आहे?",
    locationSub: "अचूक ठिकाण निवडण्यासाठी नकाशावर क्लिक करा किंवा तुमचे GPS वापरा.",
    whoAreYou: "आपली माहिती",
    contactSub: "अनामित तक्रारी स्वीकारल्या जातात. संपर्क माहितीमुळे तुम्हाला निवारणाचे अपडेट्स मिळतात.",
    fullName: "पूर्ण नाव",
    phone: "मोबाईल क्रमांक",
    email: "ईमेल पत्ता",
    confirmReportTitle: "तुमच्या तक्रारीची पुष्टी करा",
    reviewNotice: "सबमिट केल्यानंतर, तुम्हाला थेट प्रगती पाहण्यासाठी महापालिका ट्रॅकिंग कोड मिळेल.",
    ...
    catRoadDamage: "रस्त्याची खराबी",
    catWaterLeakage: "पाणी गळती",
    catDrainage: "गटार / सांडपाणी",
    catGarbage: "कचरा समस्या",
    catStreetlight: "पथदिवे",
    catPublicSafety: "सार्वजनिक सुरक्षा",
    catPothole: "रस्त्यातील खड्डा",
    catSewage: "मलनिस्सारण",
    catTreeParks: "झाडे/बागकाम",
    catOther: "इतर",
