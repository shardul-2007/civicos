var du=Object.defineProperty;var fu=(n,e,t)=>e in n?du(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var ea=(n,e,t)=>fu(n,typeof e!="symbol"?e+"":e,t);import{r as W,a as uu,u as Vo,L as st,b as Wi,R as vr,d as gd,e as hu,f as pu,h as gt,N as mu,B as gu}from"./react-BPMFOZ0g.js";import{L as xu,F as Kn,M as tn,B as Xo,T as xd,a as dr,C as Fn,U as Xa,b as Es,S as Mn,c as zn,d as yu,e as vu,X as Kt,G as fr,f as bu,g as Fi,h as yd,i as vd,j as Os,P as ta,k as En,l as or,H as Su,R as bd,m as lr,Z as li,A as ur,n as Sd,o as Ut,D as _u,I as Mu,p as br,q as Eu,r as _d,s as Md,t as Sr,u as wu,v as Ed,w as Tu,x as Au,y as qa,z as Cu,E as Ru,J as dn,K as wd,N as Td,O as Ad,Q as Cd,V as Ul,W as Fs,Y as Iu,_ as Rd,$ as Id,a0 as qo,a1 as Yo,a2 as Pd,a3 as Lr,a4 as Pu,a5 as Dd,a6 as Du,a7 as Ld,a8 as Lu,a9 as Nu}from"./lucide-RXXHfbV0.js";import{R as Nd,A as Uu,X as Ud,Y as Od,T as Fd,a as Ol,B as Ou,b as Fl}from"./recharts-Dd5yexXk.js";import{L as Nn,M as zs,T as Bs,C as Fu,a as ks,P as zu,u as Bu,b as ku}from"./leaflet-C6w747eu.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(r){if(r.ep)return;r.ep=!0;const a=t(r);fetch(r.href,a)}})();var zd={exports:{}},js={};/**
 * @license React
 ...
 */var ju=W,Wu=Symbol.for("react.element"),Hu=Symbol.for("react.fragment"),Gu=Object.prototype.hasOwnProperty,Vu=ju.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Xu={key:!0,ref:!0,__self:!0,__source:!0};function Bd(n,e,t){var i,r={},a=null,o=null;t!==void 0&&(a=""+t),e.key!==void 0&&(a=""+e.key),e.ref!==void 0&&(o=e.ref);for(i in e)Gu.call(e,i)&&!Xu.hasOwnProperty(i)&&(r[i]=e[i]);if(n&&n.defaultProps)for(i in e=n.defaultProps,e)r[i]===void 0&&(r[i]=e[i]);return{$$typeof:Wu,type:n,key:a,ref:o,props:r,_owner:Vu.current}}js.Fragment=Hu;js.jsx=Bd;js.jsxs=Bd;zd.exports=js;var s=zd.exports,Ya={},zl=uu;Ya.createRoot=zl.createRoot,Ya.hydrateRoot=zl.hydrateRoot;function kd(n,e){return function(){return n.apply(e,arguments)}}const{toString:qu}=Object.prototype,{getPrototypeOf:zi}=Object,{iterator:_r,toStringTag:jd}=Symbol,ws=(({hasOwnProperty:n})=>(e,t)=>n.call(e,t))(Object.prototype),hr=(n,e)=>{let t=n;const i=[];for(;t!=null&&t!==Object.prototype;){if(i.indexOf(t)!==-1)return!1;if(i.push(t),ws(t,e))return!0;t=zi(t)}return!1},Yu=(n,e)=>n!=null&&hr(n,e)?n[e]:void 0,$o=(n=>e=>{const t=qu.call(e);return n[t]||(n[t]=t.slice(8,-1).toLowerCase())})(Object.create(null)),nn=n=>(n=n.toLowerCase(),e=>$o(e)===n),Ws=n=>e=>typeof e===n,{isArray:ci}=Array,di=Ws("undefined");function Hi(n){return n!==null&&!di(n)&&n.constructor!==null&&!di(n.constructor)&&Ht(n.constructor.isBuffer)&&n.constructor.isBuffer(n)}const Wd=nn("ArrayBuffer");function $u(n){let e;return typeof ArrayBuffer<"u"&&ArrayBuffer.isView?e=ArrayBuffer.isView(n):e=n&&n.buffer&&Wd(n.buffer),e}const Ku=Ws("string"),Ht=Ws("function"),Hd=Ws("number"),Gi=n=>n!==null&&typeof n=="object",Zu=n=>n===!0||n===!1,ps=n=>{if(!Gi(n))return!1;const e=zi(n);return(e===null||e===Object.prototype||zi(e)===null)&&!hr(n,jd)&&!hr(n,_r)},Ju=n=>{if(!Gi(n)||Hi(n))return!1;try{return Object.keys(n).length===0&&Object.getPrototypeOf(n)===Object.prototype}catch{return!1}},Qu=nn("Date"),eh=nn("File"),th=n=>!!(n&&typeof n.uri<"u"),nh=n=>n&&typeof n.getParts<"u",ih=nn("Blob"),rh=nn("FileList"),sh=nn("Set"),ah=n=>Gi(n)&&Ht(n.pipe);function oh(){return typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}}const Bl=oh(),kl=typeof Bl.FormData<"u"?Bl.FormData:void 0,lh=n=>{if(!n)return!1;if(kl&&n instanceof kl)return!0;const e=zi(n);if(!e||e===Object.prototype||!Ht(n.append))return!1;const t=$o(n);return t==="formdata"||t==="object"&&Ht(n.toString)&&n.toString()==="[object FormData]"},ch=nn("URLSearchParams"),[dh,fh,uh,hh]=["ReadableStream","Request","Response","Headers"].map(nn),ph=n=>n.trim?n.trim():n.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"");function Mr(n,e,{allOwnKeys:t=!1}={}){if(n===null||typeof n>"u")return;let i,r;if(typeof n!="object"&&(n=[n]),ci(n))for(i=0,r=n.length;i<r;i++)e.call(null,n[i],i,n);else{if(Hi(n))return;const a=t?Object.getOwnPropertyNames(n):Object.keys(n),o=a.length;let l;for(i=0;i<o;i++)l=a[i],e.call(null,n[l],l,n)}}function Gd(n,e){if(Hi(n))return null;e=e.toLowerCase();const t=Object.keys(n);let i=t.length,r;for(;i-- >0;)if(r=t[i],e===r.toLowerCase())return r;return null}const ri=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:global,Vd=n=>!di(n)&&n!==ri;function $a(...n){const{caseless:e,skipUndefined:t}=Vd(this)&&this||{},i={},r=(a,o)=>{if(o==="__proto__"||o==="constructor"||o==="prototype")return;const l=e&&typeof o=="string"&&Gd(i,o)||o,d=ws(i,l)?i[l]:void 0;ps(d)&&ps(a)?i[l]=$a(d,a):ps(a)?i[l]=$a({},a):ci(a)?i[l]=a.slice():(!t||!di(a))&&(i[l]=a)};for(let a=0,o=n.length;a<o;a++){const l=n[a];if(!l||Hi(l)||(Mr(l,r),typeof l!="object"||ci(l)))continue;const d=Object.getOwnPropertySymbols(l);for(let c=0;c<d.length;c++){const f=d[c];Th.call(l,f)&&r(l[f],f)}}return i}const mh=(n,e,t,{allOwnKeys:i}={})=>(Mr(e,(r,a)=>{t&&Ht(r)?Object.defineProperty(n,a,{__proto__:null,value:kd(r,t),writable:!0,enumerable:!0,configurable:!0}):Object.defineProperty(n,a,{__proto__:null,value:r,writable:!0,enumerable:!0,configurable:!0})},{allOwnKeys:i}),n),gh=n=>(n.charCodeAt(0)===65279&&(n=n.slice(1)),n),xh=(n,e,t,i)=>{n.prototype=Object.create(e.prototype,i),Object.defineProperty(n.prototype,"constructor",{__proto__:null,value:n,writable:!0,enumerable:!1,configurable:!0}),Object.defineProperty(n,"super",{__proto__:null,value:e.prototype}),t&&Object.assign(n.prototype,t)},yh=(n,e,t,i)=>{let r,a,o;const l={};if(e=e||{},n==null)return e;do{for(r=Object.getOwnPropertyNames(n),a=r.length;a-- >0;)o=r[a],(!i||i(o,n,e))&&!l[o]&&(e[o]=n[o],l[o]=!0);n=t!==!1&&zi(n)}while(n&&(!t||t(n,e))&&n!==Object.prototype);return e},vh=(n,e,t)=>{n=String(n),(t===void 0||t>n.length)&&(t=n.length),t-=e.length;const i=n.indexOf(e,t);return i!==-1&&i===t},bh=n=>{if(!n)return null;if(ci(n))return n;let e=n.length;if(!Hd(e))return null;const t=new Array(e);for(;e-- >0;)t[e]=n[e];return t},Sh=(n=>e=>n&&e instanceof n)(typeof Uint8Array<"u"&&zi(Uint8Array)),_h=(n,e)=>{const i=(n&&n[_r]).call(n);let r;for(;(r=i.next())&&!r.done;){const a=r.value;e.call(n,a[0],a[1])}},Mh=(n,e)=>{let t;const i=[];for(;(t=n.exec(e))!==null;)i.push(t);return i},Eh=nn("HTMLFormElement"),wh=n=>n.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g,function(t,i,r){return i.toUpperCase()+r}),{propertyIsEnumerable:Th}=Object.prototype,Ah=nn("RegExp"),Xd=(n,e)=>{const t=Object.getOwnPropertyDescriptors(n),i={};Mr(t,(r,a)=>{let o;(o=e(r,a,n))!==!1&&(i[a]=o||r)}),Object.defineProperties(n,i)},Ch=n=>{Xd(n,(e,t)=>{if(Ht(n)&&["arguments","caller","callee"].includes(t))return!1;const i=n[t];if(Ht(i)){if(e.enumerable=!1,"writable"in e){e.writable=!1;return}e.set||(e.set=()=>{throw Error("Can not rewrite read-only method '"+t+"'")})}})},Rh=(n,e)=>{const t={},i=r=>{r.forEach(a=>{t[a]=!0})};return ci(n)?i(n):i(String(n).split(e)),t},Ih=()=>{},Ph=(n,e)=>n!=null&&Number.isFinite(n=+n)?n:e;function Dh(n){return!!(n&&Ht(n.append)&&n[jd]==="FormData"&&n[_r])}const Lh=n=>{const e=new WeakSet,t=i=>{if(Gi(i)){if(e.has(i))return;if(Hi(i))return i;if(!("toJSON"in i)){e.add(i);let r;if(sh(i)){r=[];for(const a of i){const o=t(a);!di(o)&&r.push(o)}}else r=ci(i)?[]:{},Mr(i,(a,o)=>{const l=t(a);!di(l)&&(r[o]=l)});return e.delete(i),r}}return i};return t(n)},Nh=nn("AsyncFunction"),Uh=n=>n&&(Gi(n)||Ht(n))&&Ht(n.then)&&Ht(n.catch),qd=((n,e)=>n?setImmediate:e?((t,i)=>(ri.addEventListener("message",({source:r,data:a})=>{r===ri&&a===t&&i.length&&i.shift()()},!1),r=>{i.push(r),ri.postMessage(t,"*")}))(`axios@${Math.random()}`,[]):t=>setTimeout(t))(typeof setImmediate=="function",Ht(ri.postMessage)),Oh=typeof queueMicrotask<"u"?queueMicrotask.bind(ri):typeof process<"u"&&process.nextTick||qd,Yd=n=>n!=null&&Ht(n[_r]),Fh=n=>n!=null&&hr(n,_r)&&Yd(n),N={isArray:ci,isArrayBuffer:Wd,isBuffer:Hi,isFormData:lh,isArrayBufferView:$u,isString:Ku,isNumber:Hd,isBoolean:Zu,isObject:Gi,isPlainObject:ps,isEmptyObject:Ju,isReadableStream:dh,isRequest:fh,isResponse:uh,isHeaders:hh,isUndefined:di,isDate:Qu,isFile:eh,isReactNativeBlob:th,isReactNative:nh,isBlob:ih,isRegExp:Ah,isFunction:Ht,isStream:ah,isURLSearchParams:ch,isTypedArray:Sh,isFileList:rh,forEach:Mr,merge:$a,extend:mh,trim:ph,stripBOM:gh,inherits:xh,toFlatObject:yh,kindOf:$o,kindOfTest:nn,endsWith:vh,toArray:bh,forEachEntry:_h,matchAll:Mh,isHTMLForm:Eh,hasOwnProperty:ws,hasOwnProp:ws,hasOwnInPrototypeChain:hr,getSafeProp:Yu,reduceDescriptors:Xd,freezeMethods:Ch,toObjectSet:Rh,toCamelCase:wh,noop:Ih,toFiniteNumber:Ph,findKey:Gd,global:ri,isContextDefined:Vd,isSpecCompliantForm:Dh,toJSONObject:Lh,isAsyncFn:Nh,isThenable:Uh,setImmediate:qd,asap:Oh,isIterable:Yd,isSafeIterable:Fh},zh=N.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]),Bh=n=>{const e={};let t,i,r;return n&&n.split(`
`).forEach(function(o){r=o.indexOf(":"),t=o.substring(0,r).trim().toLowerCase(),i=o.substring(r+1).trim();const l=N.hasOwnProp(e,t);!t||l&&N.hasOwnProp(zh,t)||(t==="set-cookie"?l?e[t].push(i):e[t]=[i]:e[t]=l?e[t]+", "+i:i)}),e};function kh(n){let e=0,t=n.length;for(;e<t;){const i=n.charCodeAt(e);if(i!==9&&i!==32)break;e+=1}for(;t>e;){const i=n.charCodeAt(t-1);if(i!==9&&i!==32)break;t-=1}return e===0&&t===n.length?n:n.slice(e,t)}const jh=new RegExp("[\\u0000-\\u0008\\u000a-\\u001f\\u007f]+","g"),Wh=new RegExp("[^\\u0009\\u0020-\\u007e\\u0080-\\u00ff]+","g");function Ko(n,e){return N.isArray(n)?n.map(t=>Ko(t,e)):kh(String(n).replace(e,""))}const Hh=n=>Ko(n,jh),Gh=n=>Ko(n,Wh);function $d(n){const e=Object.create(null);return N.forEach(n.toJSON(),(t,i)=>{e[i]=Gh(t)}),e}const jl=Symbol("internals");function Yi(n){return n&&String(n).trim().toLowerCase()}function ms(n){return n===!1||n==null?n:N.isArray(n)?n.map(ms):Hh(String(n))}function Vh(n){const e=Object.create(null),t=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;let i;for(;i=t.exec(n);)e[i[1]]=i[2];return e}const Xh=/^[!#$%&'*+\-.^_`|~0-9A-Za-z]+$/;function na(n){let e=0,t=n.length;for(;e<t;){const i=n.charCodeAt(e);if(i!==9&&i!==32)break;e+=1}for(;t>e;){const i=n.charCodeAt(t-1);if(i!==9&&i!==32)break;t-=1}return e===0&&t===n.length?n:n.slice(e,t)}function qh(n){const e=n.length-1;if(e<1||n.charCodeAt(0)!==34||n.charCodeAt(e)!==34)return n;let t="";for(let i=1;i<e;i++){const r=n.charCodeAt(i);if(r===34||r===92&&(i+=1,i>=e))return n;t+=n[i]}return t}function Yh(n){const e=Object.create(null),t=String(n);let i=0,r=!1,a=!1;function o(l){const d=na(t.slice(i,l)),c=d.indexOf("=");if(c<1)return;const f=na(d.slice(0,c));if(!Xh.test(f))return;const h=f.toLowerCase();if(h==="__proto__"||h==="constructor"||h==="prototype")return;const u=na(d.slice(c+1));e[h]=qh(u)}for(let l=0;l<t.length;l++){const d=t.charCodeAt(l);r?a?a=!1:d===92?a=!0:d===34&&(r=!1):d===34?r=!0:(d===44||d===59)&&(o(l),i=l+1)}return o(t.length),e}const $h=n=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(n.trim());function ia(n,e,t,i,r){if(N.isFunction(i))return i.call(this,e,t);if(r&&(e=t),!!N.isString(e)){if(N.isString(i))return e.indexOf(i)!==-1;if(N.isRegExp(i))return i.test(e)}}function Kh(n){return n.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(e,t,i)=>t.toUpperCase()+i)}function Zh(n,e){const t=N.toCamelCase(" "+e);["get","set","has"].forEach(i=>{Object.defineProperty(n,i+t,{__proto__:null,value:function(r,a,o){return this[i].call(this,e,r,a,o)},configurable:!0})})}let Ft=class{constructor(e){e&&this.set(e)}set(e,t,i){const r=this;function a(l,d,c){const f=Yi(d);if(!f)return;const h=N.findKey(r,f);(!h||r[h]===void 0||c===!0||c===void 0&&r[h]!==!1)&&(r[h||d]=ms(l))}const o=(l,d)=>N.forEach(l,(c,f)=>a(c,f,d));if(N.isPlainObject(e)||e instanceof this.constructor)o(e,t);else if(N.isString(e)&&(e=e.trim())&&!$h(e))o(Bh(e),t);else if(N.isObject(e)&&N.isSafeIterable(e)){let l=Object.create(null),d,c;for(const f of e){if(!N.isArray(f))throw new TypeError("Object iterator must return a key-value pair");c=f[0],N.hasOwnProp(l,c)?(d=l[c],l[c]=N.isArray(d)?[...d,f[1]]:[d,f[1]]):l[c]=f[1]}o(l,t)}else e!=null&&a(t,e,i);return this}get(e,t){if(e=Yi(e),e){const i=N.findKey(this,e);if(i){const r=this[i];if(!t)return r;if(t===!0)return Vh(r);if(N.isFunction(t))return t.call(this,r,i);if(N.isRegExp(t))return t.exec(r);throw new TypeError("parser must be boolean|regexp|function")}}}has(e,t){if(e=Yi(e),e){const i=N.findKey(this,e);return!!(i&&this[i]!==void 0&&(!t||ia(this,this[i],i,t)))}return!1}delete(e,t){const i=this;let r=!1;function a(o){if(o=Yi(o),o){const l=N.findKey(i,o);l&&(!t||ia(i,i[l],l,t))&&(delete i[l],r=!0)}}return N.isArray(e)?e.forEach(a):a(e),r}clear(e){const t=Object.keys(this);let i=t.length,r=!1;for(;i--;){const a=t[i];(!e||ia(this,this[a],a,e,!0))&&(delete this[a],r=!0)}return r}normalize(e){const t=this,i={};return N.forEach(this,(r,a)=>{const o=N.findKey(i,a);if(o){t[o]=ms(r),delete t[a];return}const l=e?Kh(a):String(a).trim();l!==a&&delete t[a],t[l]=ms(r),i[l]=!0}),this}concat(...e){return this.constructor.concat(this,...e)}toJSON(e){const t=Object.create(null);return N.forEach(this,(i,r)=>{i!=null&&i!==!1&&(t[r]=e&&N.isArray(i)?i.join(", "):i)}),t}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([e,t])=>e+": "+t).join(`
`)}getSetCookie(){const e=this.get("set-cookie");return N.isArray(e)?e:e==null||e===!1?[]:[e]}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(e){return e instanceof this?e:new this(e)}static parseParameters(e){return Yh(e)}static concat(e,...t){const i=new this(e);return t.forEach(r=>i.set(r)),i}static accessor(e){const i=(this[jl]=this[jl]={accessors:{}}).accessors,r=this.prototype;function a(o){const l=Yi(o);i[l]||(Zh(r,o),i[l]=!0)}return N.isArray(e)?e.forEach(a):a(e),this}};Ft.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]);N.reduceDescriptors(Ft.prototype,({value:n},e)=>{let t=e[0].toUpperCase()+e.slice(1);return{get:()=>n,set(i){this[t]=i}}});N.freezeMethods(Ft);const Ts="[REDACTED ****]";function Jh(n){if(N.hasOwnProp(n,"toJSON"))return!0;let e=Object.getPrototypeOf(n);for(;e&&e!==Object.prototype;){if(N.hasOwnProp(e,"toJSON"))return!0;e=Object.getPrototypeOf(e)}return!1}function Qh(n,e){const t=new Set(e.map(a=>String(a).toLowerCase())),i=[],r=a=>{if(a===null||typeof a!="object"||N.isBuffer(a))return a;if(i.indexOf(a)!==-1)return;a instanceof Ft&&(a=a.toJSON()),i.push(a);let o;if(N.isArray(a))o=[],a.forEach((l,d)=>{const c=r(l);N.isUndefined(c)||(o[d]=c)});else{if(!N.isPlainObject(a)&&Jh(a))return i.pop(),a;o=Object.create(null);for(const[l,d]of Object.entries(a)){const c=t.has(l.toLowerCase())?Ts:r(d);N.isUndefined(c)||(o[l]=c)}}return i.pop(),o};return r(n)}function Wl(n){try{return String(n)}catch{return""}}function ep(n){return n.errors.map(t=>{try{return t&&t.message?Wl(t.message):Wl(t)}catch{return""}}).filter(Boolean).join("; ")||n.name||"AggregateError"}let Se=class Kd extends Error{static from(e,t,i,r,a,o){let l=e.message;!l&&N.isArray(e.errors)&&e.errors.length&&(l=ep(e));const d=new Kd(l,t||e.code,i,r,a);return Object.defineProperty(d,"cause",{__proto__:null,value:e,writable:!0,enumerable:!1,configurable:!0}),d.name=e.name,e.status!=null&&d.status==null&&(d.status=e.status),o&&Object.assign(d,o),d}constructor(e,t,i,r,a){super(e),Object.defineProperty(this,"message",{__proto__:null,value:e,enumerable:!0,writable:!0,configurable:!0}),this.name="AxiosError",this.isAxiosError=!0,t&&(this.code=t),i&&(this.config=i),r&&(this.request=r),a&&(this.response=a,this.status=a.status)}toJSON(){const e=this.config,t=e&&N.hasOwnProp(e,"redact")?e.redact:void 0,i=N.isArray(t)&&t.length>0?Qh(e,t):N.toJSONObject(e);return{message:this.message,name:this.name,description:this.description,number:this.number,fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,config:i,code:this.code,status:this.status}}};Se.ERR_BAD_OPTION_VALUE="ERR_BAD_OPTION_VALUE";Se.ERR_BAD_OPTION="ERR_BAD_OPTION";Se.ECONNABORTED="ECONNABORTED";Se.ETIMEDOUT="ETIMEDOUT";Se.ECONNREFUSED="ECONNREFUSED";Se.ERR_NETWORK="ERR_NETWORK";Se.ERR_FR_TOO_MANY_REDIRECTS="ERR_FR_TOO_MANY_REDIRECTS";Se.ERR_DEPRECATED="ERR_DEPRECATED";Se.ERR_BAD_RESPONSE="ERR_BAD_RESPONSE";Se.ERR_BAD_REQUEST="ERR_BAD_REQUEST";Se.ERR_CANCELED="ERR_CANCELED";Se.ERR_NOT_SUPPORT="ERR_NOT_SUPPORT";Se.ERR_INVALID_URL="ERR_INVALID_URL";Se.ERR_FORM_DATA_DEPTH_EXCEEDED="ERR_FORM_DATA_DEPTH_EXCEEDED";const tp=null,Zd=100;function Ka(n){return N.isPlainObject(n)||N.isArray(n)}function Jd(n){return N.endsWith(n,"[]")?n.slice(0,-2):n}function ra(n,e,t){return n?n.concat(e).map(function(r,a){return r=Jd(r),!t&&a?"["+r+"]":r}).join(t?".":""):e}function np(n){return N.isArray(n)&&!n.some(Ka)}const ip=N.toFlatObject(N,{},null,function(e){return/^is[A-Z]/.test(e)});function Hs(n,e,t){if(!N.isObject(n))throw new TypeError("target must be an object");e=e||new FormData,t=N.toFlatObject(t,{metaTokens:!0,dots:!1,indexes:!1},!1,function(M,T){return!N.isUndefined(T[M])});const i=t.metaTokens,r=t.visitor||x,a=t.dots,o=t.indexes,l=t.Blob||typeof Blob<"u"&&Blob,d=t.maxDepth===void 0?Zd:t.maxDepth,c=l&&N.isSpecCompliantForm(e),f=[];if(!N.isFunction(r))throw new TypeError("visitor must be a function");function h(p){if(p===null)return"";if(N.isDate(p))return p.toISOString();if(N.isBoolean(p))return p.toString();if(!c&&N.isBlob(p))throw new Se("Blob is not supported. Use a Buffer instead.");if(N.isArrayBuffer(p)||N.isTypedArray(p)){if(c&&typeof l=="function")return new l([p]);throw new Se("Blob is not supported. Use a Buffer instead.",Se.ERR_NOT_SUPPORT)}return p}function u(p){if(p>d)throw new Se("Object is too deeply nested ("+p+" levels). Max depth: "+d,Se.ERR_FORM_DATA_DEPTH_EXCEEDED)}function m(p,M){if(d===1/0)return JSON.stringify(p);const T=[];return JSON.stringify(p,function(v,w){if(!N.isObject(w))return w;for(;T.length&&T[T.length-1]!==this;)T.pop();return T.push(w),u(M+T.length-1),w})}function x(p,M,T){let _=p;if(N.isReactNative(e)&&N.isReactNativeBlob(p))return e.append(ra(T,M,a),h(p)),!1;if(p&&!T&&typeof p=="object"){if(N.endsWith(M,"{}"))M=i?M:M.slice(0,-2),p=m(p,1);else if(N.isArray(p)&&np(p)||(N.isFileList(p)||N.endsWith(M,"[]"))&&(_=N.toArray(p)))return M=Jd(M),_.forEach(function(w,R){!(N.isUndefined(w)||w===null)&&e.append(o===!0?ra([M],R,a):o===null?M:M+"[]",h(w))}),!1}return Ka(p)?!0:(e.append(ra(T,M,a),h(p)),!1)}const S=Object.assign(ip,{defaultVisitor:x,convertValue:h,isVisitable:Ka});function g(p,M,T=0){if(!N.isUndefined(p)){if(u(T),f.indexOf(p)!==-1)throw new Error("Circular reference detected in "+M.join("."));f.push(p),N.forEach(p,function(v,w){(!(N.isUndefined(v)||v===null)&&r.call(e,v,N.isString(w)?w.trim():w,M,S))===!0&&g(v,M?M.concat(w):[w],T+1)}),f.pop()}}if(!N.isObject(n))throw new TypeError("data must be an object");return g(n),e}function Hl(n){const e={"!":"%21","'":"%27","(":"%28",")":"%29","~":"%7E","%20":"+"};return encodeURIComponent(n).replace(/[!'()~]|%20/g,function(i){return e[i]})}function Zo(n,e){this._pairs=[],n&&Hs(n,this,e)}const Qd=Zo.prototype;Qd.append=function(e,t){this._pairs.push([e,t])};Qd.toString=function(e){const t=e?i=>e.call(this,i,Hl):Hl;return this._pairs.map(function(r){return t(r[0])+"="+t(r[1])},"").join("&")};function rp(n){return encodeURIComponent(n).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+")}function ef(n,e,t){if(!e)return n;n=n||"";const i=N.isFunction(t)?{serialize:t}:t,r=N.getSafeProp(i,"encode")||rp,a=N.getSafeProp(i,"serialize");let o;if(a?o=a(e,i):o=N.isURLSearchParams(e)?e.toString():new Zo(e,i).toString(r),o){const l=n.indexOf("#");l!==-1&&(n=n.slice(0,l)),n+=(n.indexOf("?")===-1?"?":"&")+o}return n}class Gl{constructor(){this.handlers=[]}use(e,t,i){return this.handlers.push({fulfilled:e,rejected:t,synchronous:i?i.synchronous:!1,runWhen:i?i.runWhen:null}),this.handlers.length-1}eject(e){this.handlers[e]&&(this.handlers[e]=null)}clear(){this.handlers&&(this.handlers=[])}forEach(e){N.forEach(this.handlers,function(i){i!==null&&e(i)})}}const Jo={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1,legacyInterceptorReqResOrdering:!0,advertiseZstdAcceptEncoding:!1,validateStatusUndefinedResolves:!0},sp=typeof URLSearchParams<"u"?URLSearchParams:Zo,ap=typeof FormData<"u"?FormData:null,op=typeof Blob<"u"?Blob:null,lp={isBrowser:!0,classes:{URLSearchParams:sp,FormData:ap,Blob:op},protocols:["http","https","file","blob","url","data"]},Qo=typeof window<"u"&&typeof document<"u",Za=typeof navigator=="object"&&navigator||void 0,cp=Qo&&(!Za||["ReactNative","NativeScript","NS"].indexOf(Za.product)<0),dp=typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope&&typeof self.importScripts=="function",fp=Qo&&window.location.href||"http://localhost",up=Object.freeze(Object.defineProperty({__proto__:null,hasBrowserEnv:Qo,hasStandardBrowserEnv:cp,hasStandardBrowserWebWorkerEnv:dp,navigator:Za,origin:fp},Symbol.toStringTag,{value:"Module"})),At={...up,...lp};function hp(n,e){return Hs(n,new At.classes.URLSearchParams,{visitor:function(t,i,r,a){return At.isNode&&N.isBuffer(t)?(this.append(i,t.toString("base64")),!1):a.defaultVisitor.apply(this,arguments)},...e})}const Vl=Zd;function tf(n){if(n>Vl)throw new Se("FormData field is too deeply nested ("+n+" levels). Max depth: "+Vl,Se.ERR_FORM_DATA_DEPTH_EXCEEDED)}function pp(n){const e=[],t=/[^.[\]]+|\[([^.[\]]*)]/g;let i;for(;(i=t.exec(n))!==null;)tf(e.length),e.push(i[0]==="[]"?"":i[1]||i[0]);return e}function mp(n){const e={},t=Object.keys(n);let i;const r=t.length;let a;for(i=0;i<r;i++)a=t[i],e[a]=n[a];return e}function nf(n){function e(t,i,r,a){tf(a);let o=t[a++];if(o==="__proto__")return!0;const l=Number.isFinite(+o),d=a>=t.length;return o=!o&&N.isArray(r)?r.length:o,d?(N.hasOwnProp(r,o)?r[o]=N.isArray(r[o])?r[o].concat(i):[r[o],i]:r[o]=i,!l):((!N.hasOwnProp(r,o)||!N.isObject(r[o]))&&(r[o]=[]),e(t,i,r[o],a)&&N.isArray(r[o])&&(r[o]=mp(r[o])),!l)}if(N.isFormData(n)&&N.isFunction(n.entries)){const t={};return N.forEachEntry(n,(i,r)=>{e(pp(i),r,t,0)}),t}return null}const vi=(n,e)=>n!=null&&N.hasOwnProp(n,e)?n[e]:void 0;function gp(n,e,t){if(N.isString(n))try{return(e||JSON.parse)(n),N.trim(n)}catch(i){if(i.name!=="SyntaxError")throw i}return(t||JSON.stringify)(n)}const Er={transitional:Jo,adapter:["xhr","http","fetch"],transformRequest:[function(e,t){const i=t.getContentType()||"",r=i.indexOf("application/json")>-1,a=N.isObject(e);if(a&&N.isHTMLForm(e)&&(e=new FormData(e)),N.isFormData(e))return r?JSON.stringify(nf(e)):e;if(N.isArrayBuffer(e)||N.isBuffer(e)||N.isStream(e)||N.isFile(e)||N.isBlob(e)||N.isReadableStream(e))return e;if(N.isArrayBufferView(e))return e.buffer;if(N.isURLSearchParams(e))return t.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),e.toString();let l;if(a){const d=vi(this,"formSerializer");if(i.indexOf("application/x-www-form-urlencoded")>-1)return hp(e,d).toString();if((l=N.isFileList(e))||i.indexOf("multipart/form-data")>-1){const c=vi(this,"env"),f=c&&c.FormData;return Hs(l?{"files[]":e}:e,f&&new f,d)}}return a||r?(t.setContentType("application/json",!1),gp(e)):e}],transformResponse:[function(e){const t=vi(this,"transitional")||Er.transitional,i=t&&t.forcedJSONParsing,r=vi(this,"responseType"),a=r==="json";if(N.isResponse(e)||N.isReadableStream(e))return e;if(e&&N.isString(e)&&(i&&!r||a)){const l=!(t&&t.silentJSONParsing)&&a;try{return JSON.parse(e,vi(this,"parseReviver"))}catch(d){if(l)throw d.name==="SyntaxError"?Se.from(d,Se.ERR_BAD_RESPONSE,this,null,vi(this,"response")):d}}return e}],timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:At.classes.FormData,Blob:At.classes.Blob},validateStatus:function(e){return e>=200&&e<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};N.forEach(["delete","get","head","post","put","patch","query"],n=>{Er.headers[n]={}});function sa(n,e){const t=this||Er,i=e||t,r=Ft.from(i.headers);let a=i.data;return N.forEach(n,function(l){a=l.call(t,a,r.normalize(),e?e.status:void 0)}),r.normalize(),a}function rf(n){return!!(n&&n.__CANCEL__)}let wr=class extends Se{constructor(e,t,i){super(e??"canceled",Se.ERR_CANCELED,t,i),this.name="CanceledError",this.__CANCEL__=!0}};function sf(n,e,t){const i=t.config.validateStatus;!t.status||!i||i(t.status)?n(t):e(new Se("Request failed with status code "+t.status,t.status>=400&&t.status<500?Se.ERR_BAD_REQUEST:Se.ERR_BAD_RESPONSE,t.config,t.request,t))}function xp(n){const e=/^([-+\w]{1,25}):(?:\/\/)?/.exec(n);return e&&e[1]||""}function yp(n,e){n=n||10;const t=new Array(n),i=new Array(n);let r=0,a=0,o;return e=e!==void 0?e:1e3,function(d){const c=Date.now(),f=i[a];o||(o=c),t[r]=d,i[r]=c;let h=a,u=0;for(;h!==r;)u+=t[h++],h=h%n;if(r=(r+1)%n,r===a&&(a=(a+1)%n),c-o<e)return;const m=f&&c-f;return m?Math.round(u*1e3/m):void 0}}function vp(n,e){let t=0,i=1e3/e,r,a;const o=(c,f=Date.now())=>{t=f,r=null,a&&(clearTimeout(a),a=null),n(...c)};return[(...c)=>{const f=Date.now(),h=f-t;h>=i?o(c,f):(r=c,a||(a=setTimeout(()=>{a=null,o(r)},i-h)))},()=>r&&o(r)]}const As=(n,e,t=3)=>{let i=0;const r=yp(50,250);return vp(a=>{if(!a||typeof a.loaded!="number")return;const o=a.loaded,l=a.lengthComputable?a.total:void 0,d=Math.max(0,l!=null?Math.min(o,l):o),c=Math.max(0,d-i),f=r(c);i=Math.max(i,d);const h={loaded:d,total:l,progress:l?d/l:void 0,bytes:c,rate:f||void 0,estimated:f&&l?(l-d)/f:void 0,event:a,lengthComputable:l!=null,[e?"download":"upload"]:!0};n(h)},t)},Xl=(n,e)=>{const t=n!=null;return[i=>e[0]({lengthComputable:t,total:n,loaded:i}),e[1]]},ql=(n,e=N.asap)=>(...t)=>e(()=>n(...t)),bp=At.hasStandardBrowserEnv?((n,e)=>t=>(t=new URL(t,At.origin),n.protocol===t.protocol&&n.host===t.host&&(e||n.port===t.port)))(new URL(At.origin),At.navigator&&/(msie|trident)/i.test(At.navigator.userAgent)):()=>!0,Sp=At.hasStandardBrowserEnv?{write(n,e,t,i,r,a,o){if(typeof document>"u")return;const l=[`${n}=${encodeURIComponent(e)}`];N.isNumber(t)&&l.push(`expires=${new Date(t).toUTCString()}`),N.isString(i)&&l.push(`path=${i}`),N.isString(r)&&l.push(`domain=${r}`),a===!0&&l.push("secure"),N.isString(o)&&l.push(`SameSite=${o}`),document.cookie=l.join("; ")},read(n){if(typeof document>"u")return null;const e=document.cookie.split(";");for(let t=0;t<e.length;t++){const i=e[t].replace(/^\s+/,""),r=i.indexOf("=");if(r!==-1&&i.slice(0,r)===n)try{return decodeURIComponent(i.slice(r+1))}catch{return i.slice(r+1)}}return null},remove(n){this.write(n,"",Date.now()-864e5,"/")}}:{write(){},read(){return null},remove(){}};function _p(n){return typeof n!="string"?!1:/^([a-z][a-z\d+\-.]*:)?\/\//i.test(n)}function Mp(n,e){if(!e)return n;let t=n.length;for(;t>0&&n.charCodeAt(t-1)===47;)t--;return n.slice(0,t)+"/"+e.replace(/^\/+/,"")}const Ep=/^https?:(?!\/\/)/i,wp=/[\t\n\r]/g;function Tp(n){let e=0;for(;e<n.length&&n.charCodeAt(e)<=32;)e++;return n.slice(e)}function Ap(n){return Tp(n).replace(wp,"")}function Cp(n){return n&&n.replace(/(^|&)([^=&]*=)?[^&]+/g,(e,t,i="")=>`${t}${i}${Ts}`)}function Rp(n){const e=n.replace(/^(https?:\/{0,2})[^/?#]*@/i,`$1${Ts}@`),t=e.indexOf("#"),r=(t===-1?e:e.slice(0,t)).replace(/([?&][^=&#]*=)[^&#]*/g,`$1${Ts}`);return t===-1?r:`${r}#${Cp(e.slice(t+1))}`}function Yl(n,e){if(typeof n=="string"){const t=Ap(n);if(Ep.test(t))throw new Se(`Invalid URL ${JSON.stringify(Rp(t))}: missing "//" after protocol`,Se.ERR_INVALID_URL,e)}}function af(n,e,t,i){Yl(e,i);let r=!_p(e);return n&&(r||t===!1)?(Yl(n,i),Mp(n,e)):e}const $l=n=>n instanceof Ft?{...n}:n,Ip=n=>Object.getOwnPropertySymbols&&Object.getOwnPropertyDescriptor?Object.keys(n).concat(Object.getOwnPropertySymbols(n).filter(e=>Object.getOwnPropertyDescriptor(n,e).enumerable)):Object.keys(n);function fi(n,e){n=n||{},e=e||{};const t=Object.create(null);Object.defineProperty(t,"hasOwnProperty",{__proto__:null,value:Object.prototype.hasOwnProperty,enumerable:!1,writable:!0,configurable:!0});function i(f,h,u,m){return N.isPlainObject(f)&&N.isPlainObject(h)?N.merge.call({caseless:m},f,h):N.isPlainObject(h)?N.merge({},h):N.isArray(h)?h.slice():h}function r(f,h,u,m){if(N.isUndefined(h)){if(!N.isUndefined(f))return i(void 0,f,u,m)}else return i(f,h,u,m)}function a(f,h){if(!N.isUndefined(h))return i(void 0,h)}function o(f,h){if(N.isUndefined(h)){if(!N.isUndefined(f))return i(void 0,f)}else return i(void 0,h)}function l(f){const h=N.hasOwnProp(e,"transitional")?e.transitional:void 0;if(!N.isUndefined(h))if(N.isPlainObject(h)){if(N.hasOwnProp(h,f))return h[f]}else return;const u=N.hasOwnProp(n,"transitional")?n.transitional:void 0;if(N.isPlainObject(u)&&N.hasOwnProp(u,f))return u[f]}function d(f,h,u){if(N.hasOwnProp(e,u))return i(f,h);if(N.hasOwnProp(n,u))return i(void 0,f)}const c={url:a,method:a,data:a,baseURL:o,transformRequest:o,transformResponse:o,paramsSerializer:o,timeout:o,timeoutMessage:o,withCredentials:o,withXSRFToken:o,adapter:o,responseType:o,xsrfCookieName:o,xsrfHeaderName:o,onUploadProgress:o,onDownloadProgress:o,decompress:o,maxContentLength:o,maxBodyLength:o,beforeRedirect:o,transport:o,httpAgent:o,httpsAgent:o,cancelToken:o,socketPath:o,allowedSocketPaths:o,responseEncoding:o,validateStatus:d,headers:(f,h,u)=>r($l(f),$l(h),u,!0)};return N.forEach(Ip({...n,...e}),function(h){if(h==="__proto__"||h==="constructor"||h==="prototype")return;const u=N.hasOwnProp(c,h)?c[h]:r,m=N.hasOwnProp(n,h)?n[h]:void 0,x=N.hasOwnProp(e,h)?e[h]:void 0,S=u(m,x,h);N.isUndefined(S)&&u!==d||(t[h]=S)}),N.hasOwnProp(e,"validateStatus")&&N.isUndefined(e.validateStatus)&&l("validateStatusUndefinedResolves")===!1&&(N.hasOwnProp(n,"validateStatus")?t.validateStatus=i(void 0,n.validateStatus):delete t.validateStatus),t}const Pp=["content-type","content-length"];function Dp(n,e,t){if(t!=="content-only"){n.set(e);return}Object.entries(e||{}).forEach(([i,r])=>{Pp.includes(i.toLowerCase())&&n.set(i,r)})}const Lp=n=>encodeURIComponent(n).replace(/%([0-9A-F]{2})/gi,(e,t)=>String.fromCharCode(parseInt(t,16)));function of(n){const e=fi({},n),t=u=>N.hasOwnProp(e,u)?e[u]:void 0,i=t("data");let r=t("withXSRFToken");const a=t("xsrfHeaderName"),o=t("xsrfCookieName");let l=t("headers");const d=t("auth"),c=t("baseURL"),f=t("allowAbsoluteUrls"),h=t("url");if(e.headers=l=Ft.from(l),e.url=ef(af(c,h,f,e),t("params"),t("paramsSerializer")),d){const u=N.getSafeProp(d,"username")||"",m=N.getSafeProp(d,"password")||"";try{l.set("Authorization","Basic "+btoa(u+":"+(m?Lp(m):"")))}catch(x){throw Se.from(x,Se.ERR_BAD_OPTION_VALUE,n)}}if(N.isFormData(i)&&(At.hasStandardBrowserEnv||At.hasStandardBrowserWebWorkerEnv||N.isReactNative(i)?l.setContentType(void 0):N.isFunction(i.getHeaders)&&Dp(l,i.getHeaders(),t("formDataHeaderPolicy"))),At.hasStandardBrowserEnv&&(N.isFunction(r)&&(r=r(e)),r===!0||r==null&&bp(e.url))){const m=a&&o&&Sp.read(o);m&&l.set(a,m)}return e}const Np=typeof XMLHttpRequest<"u",Up=Np&&function(n){return new Promise(function(t,i){const r=of(n);let a=r.data;const o=Ft.from(r.headers).normalize();let{responseType:l,onUploadProgress:d,onDownloadProgress:c}=r,f,h,u,m,x;function S(){m&&m(),x&&x(),r.cancelToken&&r.cancelToken.unsubscribe(f),r.signal&&r.signal.removeEventListener("abort",f)}let g=new XMLHttpRequest;g.open(r.method.toUpperCase(),r.url,!0),g.timeout=r.timeout;function p(){if(!g)return;const T=Ft.from("getAllResponseHeaders"in g&&g.getAllResponseHeaders()),v={data:!l||l==="text"||l==="json"?g.responseText:g.response,status:g.status,statusText:g.statusText,headers:T,config:n,request:g};sf(function(R){t(R),S()},function(R){i(R),S()},v),g=null}"onloadend"in g?g.onloadend=p:g.onreadystatechange=function(){!g||g.readyState!==4||g.status===0&&!(g.responseURL&&g.responseURL.startsWith("file:"))||setTimeout(p)},g.onabort=function(){g&&(i(new Se("Request aborted",Se.ECONNABORTED,n,g)),S(),g=null)},g.onerror=function(_){const v=_&&_.message?_.message:"Network Error",w=new Se(v,Se.ERR_NETWORK,n,g);w.event=_||null,i(w),S(),g=null},g.ontimeout=function(){let _=r.timeout?"timeout of "+r.timeout+"ms exceeded":"timeout exceeded";const v=r.transitional||Jo;r.timeoutErrorMessage&&(_=r.timeoutErrorMessage),i(new Se(_,v.clarifyTimeoutError?Se.ETIMEDOUT:Se.ECONNABORTED,n,g)),S(),g=null},a===void 0&&o.setContentType(null),"setRequestHeader"in g&&N.forEach($d(o),function(_,v){g.setRequestHeader(v,_)}),N.isUndefined(r.withCredentials)||(g.withCredentials=!!r.withCredentials),l&&l!=="json"&&(g.responseType=r.responseType),c&&([u,x]=As(c,!0),g.addEventListener("progress",u)),d&&g.upload&&([h,m]=As(d),g.upload.addEventListener("progress",h),g.upload.addEventListener("loadend",m)),(r.cancelToken||r.signal)&&(f=T=>{g&&(i(!T||T.type?new wr(null,n,g):T),g.abort(),S(),g=null)},r.cancelToken&&r.cancelToken.subscribe(f),r.signal&&(r.signal.aborted?f():r.signal.addEventListener("abort",f)));const M=xp(r.url);if(M&&!At.protocols.includes(M)){i(new Se("Unsupported protocol "+M+":",Se.ERR_BAD_REQUEST,n)),S();return}g.send(a||null)})},Op=(n,e)=>{if(n=n?n.filter(Boolean):[],!e&&!n.length)return;const t=new AbortController;let i=!1;const r=function(d){if(!i){i=!0,o();const c=d instanceof Error?d:this.reason;t.abort(c instanceof Se?c:new wr(c instanceof Error?c.message:c))}};let a=e&&setTimeout(()=>{a=null,r(new Se(`timeout of ${e}ms exceeded`,Se.ETIMEDOUT))},e);const o=()=>{n&&(a&&clearTimeout(a),a=null,n.forEach(d=>{d.unsubscribe?d.unsubscribe(r):d.removeEventListener("abort",r)}),n=null)};n.forEach(d=>{if(!i){if(d.aborted){r.call(d);return}d.addEventListener("abort",r,{once:!0})}});const{signal:l}=t;return l.unsubscribe=()=>N.asap(o),l},Fp=function*(n,e){let t=n.byteLength;if(t<e){yield n;return}let i=0,r;for(;i<t;)r=i+e,yield n.slice(i,r),i=r},zp=async function*(n,e){for await(const t of Bp(n))yield*Fp(t,e)},Bp=async function*(n){if(n[Symbol.asyncIterator]){yield*n;return}const e=n.getReader();try{for(;;){const{done:t,value:i}=await e.read();if(t)break;yield i}}finally{await e.cancel()}},Kl=(n,e,t,i)=>{const r=zp(n,e);let a=0,o,l=d=>{o||(o=!0,i&&i(d))};return new ReadableStream({async pull(d){try{const{done:c,value:f}=await r.next();if(c){l(),d.close();return}let h=f.byteLength;if(t){let u=a+=h;t(u)}d.enqueue(new Uint8Array(f))}catch(c){throw l(c),c}},cancel(d){return l(d),r.return()}},{highWaterMark:2})},Zl=n=>n>=48&&n<=57||n>=65&&n<=70||n>=97&&n<=102,lf=(n,e,t)=>e+2<t&&Zl(n.charCodeAt(e+1))&&Zl(n.charCodeAt(e+2)),Jl=n=>n<=57?n-48:(n&223)-55,kp=n=>n>=65&&n<=90||n>=97&&n<=122||n>=48&&n<=57||n===43||n===47||n===45||n===95,jp=n=>n===9||n===10||n===12||n===13||n===32,Wp=n=>{const e=Math.floor(n/4),t=n%4;return e*3+(t===2?1:t===3?2:0)},Hp=n=>{const e=n.length;let t=0;return e>0&&n.charCodeAt(e-1)===61&&(t++,e>1&&n.charCodeAt(e-2)===61&&t++),Math.floor((e-t)*3/4)},Gp=n=>{const e=n.length;let t=0,i=0,r=!1;for(let a=0;a<e;a++){let o=n.charCodeAt(a);if(o===37&&lf(n,a,e)&&(o=Jl(n.charCodeAt(a+1))*16+Jl(n.charCodeAt(a+2)),a+=2),!jp(o)){if(o===61){i++;continue}if(!kp(o)||i>0){r=!0;continue}t++}}return r||i>2||i>0&&(t+i)%4!==0||t%4===1?Hp(n):Wp(t)},Vp=(n,e)=>{if(!n||typeof n!="string"||!n.startsWith("data:"))return 0;const t=n.indexOf(",");if(t<0)return 0;const i=n.slice(5,t),r=n.slice(t+1);if(/;base64/i.test(i))return e(r);let o=0;for(let l=0,d=r.length;l<d;l++){const c=r.charCodeAt(l);if(c===37&&lf(r,l,d))o+=1,l+=2;else if(c<128)o+=1;else if(c<2048)o+=2;else if(c>=55296&&c<=56319&&l+1<d){const f=r.charCodeAt(l+1);f>=56320&&f<=57343?(o+=4,l++):o+=3}else o+=3}return o};function Xp(n){const e=typeof n=="string"?n.indexOf("#"):-1;return Vp(e===-1?n:n.slice(0,e),Gp)}const el="1.19.0",Ql=64*1024,{isFunction:Nr}=N,qp=n=>encodeURIComponent(n).replace(/%([0-9A-F]{2})/gi,(e,t)=>String.fromCharCode(parseInt(t,16))),ec=n=>{if(!N.isString(n))return n;try{return decodeURIComponent(n)}catch{return n}},tc=(n,...e)=>{try{return!!n(...e)}catch{return!1}},Yp=n=>{const e=n.indexOf("://");let t=n;return e!==-1&&(t=t.slice(e+3)),t.includes("@")||t.includes(":")},$p=n=>{const e=N.global!==void 0&&N.global!==null?N.global:globalThis,{ReadableStream:t,TextEncoder:i}=e;n=N.merge.call({skipUndefined:!0},{Request:e.Request,Response:e.Response},n);const{fetch:r,Request:a,Response:o}=n,l=r?Nr(r):typeof fetch=="function",d=Nr(a),c=Nr(o);if(!l)return!1;const f=l&&Nr(t),h=l&&(typeof i=="function"?(p=>M=>p.encode(M))(new i):async p=>new Uint8Array(await new a(p).arrayBuffer())),u=d&&f&&tc(()=>{let p=!1;const M=new a(At.origin,{body:new t,method:"POST",get duplex(){return p=!0,"half"}}),T=M.headers.has("Content-Type");return M.body!=null&&M.body.cancel(),p&&!T}),m=c&&f&&tc(()=>N.isReadableStream(new o("").body)),x={stream:m&&(p=>p.body)};l&&["text","arrayBuffer","blob","formData","stream"].forEach(p=>{!x[p]&&(x[p]=(M,T)=>{let _=M&&M[p];if(_)return _.call(M);throw new Se(`Response type '${p}' is not supported`,Se.ERR_NOT_SUPPORT,T)})});const S=async p=>{if(p==null)return 0;if(N.isBlob(p))return p.size;if(N.isSpecCompliantForm(p))return(await new a(At.origin,{method:"POST",body:p}).arrayBuffer()).byteLength;if(N.isArrayBufferView(p)||N.isArrayBuffer(p))return p.byteLength;if(N.isURLSearchParams(p)&&(p=p+""),N.isString(p))return(await h(p)).byteLength},g=async(p,M)=>{const T=N.toFiniteNumber(p.getContentLength());return T??S(M)};return async p=>{let{url:M,method:T,data:_,signal:v,cancelToken:w,timeout:R,onDownloadProgress:b,onUploadProgress:A,responseType:P,headers:I,withCredentials:O="same-origin",fetchOptions:k,maxContentLength:D,maxBodyLength:H}=of(p);const Z=N.isNumber(D)&&D>-1,$=N.isNumber(H)&&H>-1,ne=_e=>N.hasOwnProp(p,_e)?p[_e]:void 0;let z=r||fetch;P=P?(P+"").toLowerCase():"text";let X=Op([v,w&&w.toAbortSignal()],R),J=null;const fe=X&&X.unsubscribe&&(()=>{X.unsubscribe()});let ue,ke=null;const Le=()=>new Se("Request body larger than maxBodyLength limit",Se.ERR_BAD_REQUEST,p,J);try{let _e;const Y=ne("auth");if(Y){const oe=N.getSafeProp(Y,"username")||"",Fe=N.getSafeProp(Y,"password")||"";_e={username:oe,password:Fe}}if(Yp(M)){const oe=new URL(M,At.origin);if(!_e&&(oe.username||oe.password)){const Fe=ec(oe.username),Ze=ec(oe.password);_e={username:Fe,password:Ze}}(oe.username||oe.password)&&(oe.username="",oe.password="",M=oe.href)}if(_e&&(I.delete("authorization"),I.set("Authorization","Basic "+btoa(qp((_e.username||"")+":"+(_e.password||""))))),Z&&typeof M=="string"&&M.startsWith("data:")&&Xp(M)>D)throw new Se("maxContentLength size of "+D+" exceeded",Se.ERR_BAD_RESPONSE,p,J);if($&&T!=="get"&&T!=="head"){const oe=await S(_);if(typeof oe=="number"&&isFinite(oe)&&(ue=oe,oe>H))throw Le()}const ie=$&&(N.isReadableStream(_)||N.isStream(_)),ye=(oe,Fe,Ze)=>Kl(oe,Ql,lt=>{if($&&lt>H)throw ke=Le();Fe&&Fe(lt)},Ze);if(u&&T!=="get"&&T!=="head"&&(A||ie)){if(ue=ue??await g(I,_),ue!==0||ie){let oe=new a(M,{method:"POST",body:_,duplex:"half"}),Fe;if(N.isFormData(_)&&(Fe=oe.headers.get("content-type"))&&I.setContentType(Fe),oe.body){const[Ze,lt]=A&&Xl(ue,As(ql(A)))||[];_=ye(oe.body,Ze,lt)}}}else if(ie&&!d&&f&&T!=="get"&&T!=="head")_=ye(_);else if(ie&&d&&!u&&T!=="get"&&T!=="head")throw new Se("Stream request bodies are not supported by the current fetch implementation",Se.ERR_NOT_SUPPORT,p,J);N.isString(O)||(O=O?"include":"omit");const le=d&&"credentials"in a.prototype;if(N.isFormData(_)){const oe=I.getContentType();oe&&/^multipart\/form-data/i.test(oe)&&!/boundary=/i.test(oe)&&I.delete("content-type")}I.set("User-Agent","axios/"+el,!1);const Q={...k,signal:X,method:T.toUpperCase(),headers:$d(I.normalize()),body:_,duplex:"half",credentials:le?O:void 0};J=d&&new a(M,Q);let ce=await(d?z(J,k):z(M,Q));const We=Ft.from(ce.headers);if(Z){const oe=N.toFiniteNumber(We.getContentLength());if(oe!=null&&oe>D)throw new Se("maxContentLength size of "+D+" exceeded",Se.ERR_BAD_RESPONSE,p,J)}const Ce=m&&(P==="stream"||P==="response");if(m&&ce.body&&(b||Z||Ce&&fe)){const oe={};["status","statusText","headers"].forEach(ct=>{oe[ct]=ce[ct]});const Fe=N.toFiniteNumber(We.getContentLength()),[Ze,lt]=b&&Xl(Fe,As(ql(b),!0))||[];let Tt=0;const ht=ct=>{if(Z&&(Tt=ct,Tt>D))throw new Se("maxContentLength size of "+D+" exceeded",Se.ERR_BAD_RESPONSE,p,J);Ze&&Ze(ct)};ce=new o(Kl(ce.body,Ql,ht,()=>{lt&&lt(),fe&&fe()}),oe)}P=P||"text";let ze=await x[N.findKey(x,P)||"text"](ce,p);if(Z&&!m&&!Ce){let oe;if(ze!=null&&(typeof ze.byteLength=="number"?oe=ze.byteLength:typeof ze.size=="number"?oe=ze.size:typeof ze=="string"&&(oe=typeof i=="function"?new i().encode(ze).byteLength:ze.length)),typeof oe=="number"&&oe>D)throw new Se("maxContentLength size of "+D+" exceeded",Se.ERR_BAD_RESPONSE,p,J)}return!Ce&&fe&&fe(),await new Promise((oe,Fe)=>{sf(oe,Fe,{data:ze,headers:Ft.from(ce.headers),status:ce.status,statusText:ce.statusText,config:p,request:J})})}catch(_e){if(fe&&fe(),X&&X.aborted&&X.reason instanceof Se){const Y=X.reason;throw Y.config=p,J&&(Y.request=J),_e!==Y&&Object.defineProperty(Y,"cause",{__proto__:null,value:_e,writable:!0,enumerable:!1,configurable:!0}),Y}if(ke)throw J&&!ke.request&&(ke.request=J),ke;if(_e instanceof Se)throw J&&!_e.request&&(_e.request=J),_e;if(_e&&_e.name==="TypeError"&&/Load failed|fetch/i.test(_e.message)){const Y=new Se("Network Error",Se.ERR_NETWORK,p,J,_e&&_e.response);throw Object.defineProperty(Y,"cause",{__proto__:null,value:_e.cause||_e,writable:!0,enumerable:!1,configurable:!0}),Y}throw Se.from(_e,_e&&_e.code,p,J,_e&&_e.response)}}},Kp=new Map,cf=n=>{let e=n&&n.env||{};const{fetch:t,Request:i,Response:r}=e,a=[i,r,t];let o=a.length,l=o,d,c,f=Kp;for(;l--;)d=a[l],c=f.get(d),c===void 0&&f.set(d,c=l?new Map:$p(e)),f=c;return c};cf();const tl={http:tp,xhr:Up,fetch:{get:cf}};N.forEach(tl,(n,e)=>{if(n){try{Object.defineProperty(n,"name",{__proto__:null,value:e})}catch{}Object.defineProperty(n,"adapterName",{__proto__:null,value:e})}});const nc=n=>`- ${n}`,Zp=n=>N.isFunction(n)||n===null||n===!1;function Jp(n,e){n=N.isArray(n)?n:[n];const{length:t}=n;let i,r;const a={};for(let o=0;o<t;o++){i=n[o];let l;if(r=i,!Zp(i)&&(r=tl[(l=String(i)).toLowerCase()],r===void 0))throw new Se(`Unknown adapter '${l}'`);if(r&&(N.isFunction(r)||(r=r.get(e))))break;a[l||"#"+o]=r}if(!r){const o=Object.entries(a).map(([d,c])=>`adapter ${d} `+(c===!1?"is not supported by the environment":"is not available in the build"));let l=t?o.length>1?`since :
`+o.map(nc).join(`
`):" "+nc(o[0]):"as no adapter specified";throw new Se("There is no suitable adapter to dispatch the request "+l,Se.ERR_NOT_SUPPORT)}return r}const df={getAdapter:Jp,adapters:tl};function aa(n){if(n.cancelToken&&n.cancelToken.throwIfRequested(),n.signal&&n.signal.aborted)throw new wr(null,n)}function oa(n){return aa(n),n.headers=Ft.from(n.headers),n.data=sa.call(n,n.transformRequest),["post","put","patch"].indexOf(n.method)!==-1&&n.headers.setContentType("application/x-www-form-urlencoded",!1),df.getAdapter(n.adapter||Er.adapter,n)(n).then(function(i){aa(n),n.response=i;try{i.data=sa.call(n,n.transformResponse,i)}finally{delete n.response}return i.headers=Ft.from(i.headers),i},function(i){if(!rf(i)&&(aa(n),i&&i.response)){n.response=i.response;try{i.response.data=sa.call(n,n.transformResponse,i.response)}finally{delete n.response}i.response.headers=Ft.from(i.response.headers)}return Promise.reject(i)})}const Gs={};["object","boolean","number","function","string","symbol"].forEach((n,e)=>{Gs[n]=function(i){return typeof i===n||"a"+(e<1?"n ":" ")+n}});const ic={};Gs.transitional=function(e,t,i){function r(a,o){return"[Axios v"+el+"] Transitional option '"+a+"'"+o+(i?". "+i:"")}return(a,o,l)=>{if(e===!1)throw new Se(r(o," has been removed"+(t?" in "+t:"")),Se.ERR_DEPRECATED);return t&&!ic[o]&&(ic[o]=!0,console.warn(r(o," has been deprecated since v"+t+" and will be removed in the near future"))),e?e(a,o,l):!0}};Gs.spelling=function(e){return(t,i)=>(console.warn(`${i} is likely a misspelling of ${e}`),!0)};function Qp(n,e,t){if(typeof n!="object"||n===null)throw new Se("options must be an object",Se.ERR_BAD_OPTION_VALUE);const i=Object.keys(n);let r=i.length;for(;r-- >0;){const a=i[r],o=Object.prototype.hasOwnProperty.call(e,a)?e[a]:void 0;if(o){const l=n[a],d=l===void 0||o(l,a,n);if(d!==!0)throw new Se("option "+a+" must be "+d,Se.ERR_BAD_OPTION_VALUE);continue}if(t!==!0)throw new Se("Unknown option "+a,Se.ERR_BAD_OPTION)}}const gs={assertOptions:Qp,validators:Gs},Dt=gs.validators;let oi=class{constructor(e){this.defaults=e||{},this.interceptors={request:new Gl,response:new Gl}}async request(e,t){try{return await this._request(e,t)}catch(i){if(i instanceof Error){let r={};Error.captureStackTrace?Error.captureStackTrace(r):r=new Error;const a=(()=>{if(!r.stack)return"";const o=r.stack.indexOf(`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function Hy(n,e,t){return new An({name:"SphericalGaussianBlur",defines:{SAMPLES:zy,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:$s(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function Gc(){return new An({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:$s(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function Vc(){return new An({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$s(),fragmentShader:`
	...
	`}class Zf extends cn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new Gf(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new Xi(5,5,5),a=new An({name:"CubemapFromEquirect",uniforms:ji(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:Gt,blending:Un});a.uniforms.tEquirect.value=t;const o=new fn(r,a),l=t.minFilter;return t.minFilter===si&&(t.minFilter=Ot),new Vg(1,10,this).update(e,o),t.minFilter=l,o.geometry.dispose(),o.material.dispose(),this}clear(e,t=!0,i=!0,r=!0){const a=e.getRenderTarget();for(let o=0;o<6;o++)e.setRenderTarget(this,o),e.clear(t,i,r);e.setRenderTarget(a)}}function Gy(n){let e=new WeakMap,t=new WeakMap,i=null;function r(u,m=!1){return u==null?null:m?o(u):a(u)}function a(u){if(u&&u.isTexture){const m=u.mapping;if(m===ca||m===da)if(e.has(u)){const x=e.get(u).texture;return l(x,u.mapping)}else{const x=u.image;if(x&&x.height>0){const S=new Zf(x.height);return S.fromEquirectangularTexture(n,u),e.set(u,S),u.addEventListener("dispose",c),l(S.texture,u.mapping)}else return null}}return u}function o(u){if(u&&u.isTexture){const m=u.mapping,x=m===ca||m===da,S=m===hi||m===ki;if(x||S){let g=t.get(u);const p=g!==void 0?g.texture.pmremVersion:0;if(u.isRenderTargetTexture&&u.pmremVersion!==p)return i===null&&(i=new Wc(n)),g=x?i.fromEquirectangular(u,g):i.fromCubemap(u,g),g.texture.pmremVersion=u.pmremVersion,t.set(u,g),g.texture;if(g!==void 0)return g.texture;{const M=u.image;return x&&M&&M.height>0||S&&M&&d(M)?(i===null&&(i=new Wc(n)),g=x?i.fromEquirectangular(u):i.fromCubemap(u),g.texture.pmremVersion=u.pmremVersion,t.set(u,g),u.addEventListener("dispose",f),g.texture):null}}}return u}function l(u,m){return m===ca?u.mapping=hi:m===da&&(u.mapping=ki),u}function d(u){let m=0;const x=6;for(let S=0;S<x;S++)u[S]!==void 0&&m++;return m===x}function c(u){const m=u.target;m.removeEventListener("dispose",c);const x=e.get(m);x!==void 0&&(e.delete(m),x.dispose())}function f(u){const m=u.target;m.removeEventListener("dispose",f);const x=t.get(m);x!==void 0&&(t.delete(m),x.dispose())}function h(){e=new WeakMap,t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:h}}function Vy(n){const e={};function t(i){if(e[i]!==void 0)return e[i];const r=n.getExtension(i);return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&Ui("WebGLRenderer: "+i+" extension not supported."),r}}}function Xy(n,e,t,i){const r={},a=new WeakMap;function o(h){const u=h.target;u.index!==null&&e.remove(u.index);for(const x in u.attributes)e.remove(u.attributes[x]);u.removeEventListener("dispose",o),delete r[u.id];const m=a.get(u);m&&(e.remove(m),a.delete(u)),i.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function l(h,u){return r[u.id]===!0||(u.addEventListener("dispose",o),r[u.id]=!0,t.memory.geometries++),u}function d(h){const u=h.attributes;for(const m in u)e.update(u[m],n.ARRAY_BUFFER)}function c(h){const u=[],m=h.index,x=h.attributes.position;let S=0;if(x===void 0)return;if(m!==null){const M=m.array;S=m.version;for(let T=0,_=M.length;T<_;T+=3){const v=M[T+0],w=M[T+1],R=M[T+2];u.push(v,w,w,R,R,v)}}else{const M=x.array;S=x.version;for(let T=0,_=M.length/3-1;T<_;T+=3){const v=T+0,w=T+1,R=T+2;u.push(v,w,w,R,R,v)}}const g=new(x.count>=65535?kf:Bf)(u,1);g.version=S;const p=a.get(h);p&&e.remove(p),a.set(h,g)}function f(h){const u=a.get(h);if(u){const m=h.index;m!==null&&u.version<m.version&&c(h)}else c(h);return a.get(h)}return{get:l,update:d,getWireframeAttribute:f}}function qy(n,e,t){let i;function r(h){i=h}let a,o;function l(h){a=h.type,o=h.bytesPerElement}function d(h,u){n.drawElements(i,u,a,h*o),t.update(u,i,1)}function c(h,u,m){m!==0&&(n.drawElementsInstanced(i,u,a,h*o,m),t.update(u,i,m))}function f(h,u,m){if(m===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,u,0,a,h,0,m);let S=0;for(let g=0;g<m;g++)S+=u[g];t.update(S,i,1)}this.setMode=r,this.setIndex=l,this.render=d,this.renderInstances=c,this.renderMultiDraw=f}function Yy(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(a,o,l){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=l*(a/3);break;case n.LINES:t.lines+=l*(a/2);break;case n.LINE_STRIP:t.lines+=l*(a-1);break;case n.LINE_LOOP:t.lines+=l*a;break;case n.POINTS:t.points+=l*a;break;default:et("WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function $y(n,e,t){const i=new WeakMap,r=new mt;function a(o,l,d){const c=o.morphTargetInfluences,f=l.morphAttributes.position||l.morphAttributes.normal||l.morphAttributes.color,h=f!==void 0?f.length:0;let u=i.get(l);if(u===void 0||u.count!==h){let A=function(){R.dispose(),i.delete(l),l.removeEventListener("dispose",A)};u!==void 0&&u.texture.dispose();const m=l.morphAttributes.position!==void 0,x=l.morphAttributes.normal!==void 0,S=l.morphAttributes.color!==void 0,g=l.morphAttributes.position||[],p=l.morphAttributes.normal||[],M=l.morphAttributes.color||[];let T=0;m===!0&&(T=1),x===!0&&(T=2),S===!0&&(T=3);let _=l.attributes.position.count*T,v=1;_>e.maxTextureSize&&(v=Math.ceil(_/e.maxTextureSize),_=e.maxTextureSize);const w=new Float32Array(_*v*4*h),R=new Ff(w,_,v,h);R.type=vn,R.needsUpdate=!0;const b=T*4;for(let P=0;P<h;P++){const I=g[P],O=p[P],k=M[P],D=_*v*4*P;for(let H=0;H<I.count;H++){const Z=H*b;m===!0&&(r.fromBufferAttribute(I,H),w[D+Z+0]=r.x,w[D+Z+1]=r.y,w[D+Z+2]=r.z,w[D+Z+3]=0),x===!0&&(r.fromBufferAttribute(O,H),w[D+Z+4]=r.x,w[D+Z+5]=r.y,w[D+Z+6]=r.z,w[D+Z+7]=0),S===!0&&(r.fromBufferAttribute(k,H),w[D+Z+8]=r.x,w[D+Z+9]=r.y,w[D+Z+10]=r.z,w[D+Z+11]=k.itemSize===4?r.w:1)}}u={count:h,texture:R,size:new Ke(_,v)},i.set(l,u),l.addEventListener("dispose",A)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)d.getUniforms().setValue(n,"morphTexture",o.morphTexture,t);else{let m=0;for(let S=0;S<c.length;S++)m+=c[S];const x=l.morphTargetsRelative?1:1-m;d.getUniforms().setValue(n,"morphTargetBaseInfluence",x),d.getUniforms().setValue(n,"morphTargetInfluences",c)}d.getUniforms().setValue(n,"morphTargetsTexture",u.texture,t),d.getUniforms().setValue(n,"morphTargetsTextureSize",u.size)}return{update:a}}function Ky(n,e,t,i,r){let a=new WeakMap;function o(c){const f=r.render.frame,h=c.geometry,u=e.get(c,h);if(a.get(u)!==f&&(e.update(u),a.set(u,f)),c.isInstancedMesh&&(c.hasEventListener("dispose",d)===!1&&c.addEventListener("dispose",d),a.get(c)!==f&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),a.set(c,f))),c.isSkinnedMesh){const m=c.skeleton;a.get(m)!==f&&(m.update(),a.set(m,f))}return u}function l(){a=new WeakMap}function d(c){const f=c.target;f.removeEventListener("dispose",d),i.releaseStatesOfObject(f),t.remove(f.instanceMatrix),f.instanceColor!==null&&t.remove(f.instanceColor)}return{update:o,dispose:l}}const Zy={[Sf]:"LINEAR_TONE_MAPPING",[_f]:"REINHARD_TONE_MAPPING",[Mf]:"CINEON_TONE_MAPPING",[Ef]:"ACES_FILMIC_TONE_MAPPING",[Tf]:"AGX_TONE_MAPPING",[Af]:"NEUTRAL_TONE_MAPPING",[wf]:"CUSTOM_TONE_MAPPING"};function Jy(n,e,t,i,r,a){const o=new cn(e,t,{type:n,depthBuffer:r,stencilBuffer:a,samples:i?4:0,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,resolveDepthBuffer:!1,resolveStencilBuffer:!1});let l=null,d=null;const c=new zt;c.setAttribute("position",new Rt([-1,3,0,-1,-1,0,3,-1,0],3)),c.setAttribute("uv",new Rt([0,2,0,0,2,0],2));const f=new Ug({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),h=new fn(c,f),u=new vl(-1,1,1,-1,0,1);let m=null,x=null,S=!1,g,p=null,M=[],T=!1;this.setSize=function(_,v){o.setSize(_,v),l!==null&&l.setSize(_,v),d!==null&&d.setSize(_,v);for(let w=0;w<M.length;w++){const R=M[w];R.setSize&&R.setSize(_,v)}},this.setEffects=function(_){M=_,T=M.length>0&&M[0].isRenderPass===!0;const v=o.width,w=o.height;M.length>0&&l===null&&(l=new cn(v,w,{type:Tn,depthBuffer:!1,stencilBuffer:!1}),d=new cn(v,w,{type:Tn,depthBuffer:!1,stencilBuffer:!1}));for(let R=0;R<M.length;R++){const b=M[R];b.setSize&&b.setSize(v,w)}},this.begin=function(_,v){if(S||_.toneMapping===Sn&&M.length===0)return!1;if(p=v,v!==null){const w=v.width,R=v.height;(o.width!==w||o.height!==R)&&this.setSize(w,R)}return T===!1&&_.setRenderTarget(o),g=_.toneMapping,_.toneMapping=Sn,!0},this.hasRenderPass=function(){return T},this.end=function(_,v){_.toneMapping=g,S=!0;let w=o,R=l;for(let b=0;b<M.length;b++){const A=M[b];A.enabled!==!1&&(A.render(_,R,w,v),A.needsSwap!==!1&&(w=R,R=R===l?d:l))}if(m!==_.outputColorSpace||x!==_.toneMapping){m=_.outputColorSpace,x=_.toneMapping,f.defines={},Je.getTransfer(m)===rt&&(f.defines.SRGB_TRANSFER="");const b=Zy[x];b&&(f.defines[b]=""),f.needsUpdate=!0}f.uniforms.tDiffuse.value=w.texture,_.setRenderTarget(p),_.render(h,u),p=null,S=!1},this.isCompositing=function(){return S},this.dispose=function(){o.dispose(),l!==null&&l.dispose(),d!==null&&d.dispose(),c.dispose(),f.dispose()}}const Jf=new jt,Ho=new yr(1,1),Qf=new Ff,eu=new lg,tu=new Gf,Xc=[],qc=[],Yc=new Float32Array(16),$c=new Float32Array(9),Kc=new Float32Array(4);function qi(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let a=Xc[r];if(a===void 0&&(a=new Float32Array(r),Xc[r]=a),e!==0){i.toArray(a,0);for(let o=1,l=0;o!==e;++o)l+=t,n[o].toArray(a,l)}return a}function _t(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Mt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Ks(n,e){let t=qc[e];t===void 0&&(t=new Int32Array(e),qc[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function Qy(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function ev(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;n.uniform2fv(this.addr,e),Mt(t,e)}}function tv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(_t(t,e))return;n.uniform3fv(this.addr,e),Mt(t,e)}}function nv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;n.uniform4fv(this.addr,e),Mt(t,e)}}function iv(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(_t(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Mt(t,e)}else{if(_t(t,i))return;Kc.set(i),n.uniformMatrix2fv(this.addr,!1,Kc),Mt(t,i)}}function rv(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(_t(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Mt(t,e)}else{if(_t(t,i))return;$c.set(i),n.uniformMatrix3fv(this.addr,!1,$c),Mt(t,i)}}function sv(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(_t(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Mt(t,e)}else{if(_t(t,i))return;Yc.set(i),n.uniformMatrix4fv(this.addr,!1,Yc),Mt(t,i)}}function av(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function ov(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;n.uniform2iv(this.addr,e),Mt(t,e)}}function lv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(_t(t,e))return;n.uniform3iv(this.addr,e),Mt(t,e)}}function cv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;n.uniform4iv(this.addr,e),Mt(t,e)}}function dv(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function fv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;n.uniform2uiv(this.addr,e),Mt(t,e)}}function uv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(_t(t,e))return;n.uniform3uiv(this.addr,e),Mt(t,e)}}function hv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;n.uniform4uiv(this.addr,e),Mt(t,e)}}function pv(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let a;this.type===n.SAMPLER_2D_SHADOW?(Ho.compareFunction=t.isReversedDepthBuffer()?fl:dl,a=Ho):a=Jf,t.setTexture2D(e||a,r)}function mv(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||eu,r)}function gv(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||tu,r)}function xv(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||Qf,r)}function yv(n){switch(n){case 5126:return Qy;case 35664:return ev;case 35665:return tv;case 35666:return nv;case 35674:return iv;case 35675:return rv;case 35676:return sv;case 5124:case 35670:return av;case 35667:case 35671:return ov;case 35668:case 35672:return lv;case 35669:case 35673:return cv;case 5125:return dv;case 36294:return fv;case 36295:return uv;case 36296:return hv;case 35678:case 36198:case 36298:case 36306:case 35682:return pv;case 35679:case 36299:case 36307:return mv;case 35680:case 36300:case 36308:case 36293:return gv;case 36289:case 36303:case 36311:case 36292:return xv}}function vv(n,e){n.uniform1fv(this.addr,e)}function bv(n,e){const t=qi(e,this.size,2);n.uniform2fv(this.addr,t)}function Sv(n,e){const t=qi(e,this.size,3);n.uniform3fv(this.addr,t)}function _v(n,e){const t=qi(e,this.size,4);n.uniform4fv(this.addr,t)}function Mv(n,e){const t=qi(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function Ev(n,e){const t=qi(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function wv(n,e){const t=qi(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function Tv(n,e){n.uniform1iv(this.addr,e)}function Av(n,e){n.uniform2iv(this.addr,e)}function Cv(n,e){n.uniform3iv(this.addr,e)}function Rv(n,e){n.uniform4iv(this.addr,e)}function Iv(n,e){n.uniform1uiv(this.addr,e)}function Pv(n,e){n.uniform2uiv(this.addr,e)}function Dv(n,e){n.uniform3uiv(this.addr,e)}function Lv(n,e){n.uniform4uiv(this.addr,e)}function Nv(n,e,t){const i=this.cache,r=e.length,a=Ks(t,r);_t(i,a)||(n.uniform1iv(this.addr,a),Mt(i,a));let o;this.type===n.SAMPLER_2D_SHADOW?o=Ho:o=Jf;for(let l=0;l!==r;++l)t.setTexture2D(e[l]||o,a[l])}function Uv(n,e,t){const i=this.cache,r=e.length,a=Ks(t,r);_t(i,a)||(n.uniform1iv(this.addr,a),Mt(i,a));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||eu,a[o])}function Ov(n,e,t){const i=this.cache,r=e.length,a=Ks(t,r);_t(i,a)||(n.uniform1iv(this.addr,a),Mt(i,a));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||tu,a[o])}function Fv(n,e,t){const i=this.cache,r=e.length,a=Ks(t,r);_t(i,a)||(n.uniform1iv(this.addr,a),Mt(i,a));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||Qf,a[o])}function zv(n){switch(n){case 5126:return vv;case 35664:return bv;case 35665:return Sv;case 35666:return _v;case 35674:return Mv;case 35675:return Ev;case 35676:return wv;case 5124:case 35670:return Tv;case 35667:case 35671:return Av;case 35668:case 35672:return Cv;case 35669:case 35673:return Rv;case 5125:return Iv;case 36294:return Pv;case 36295:return Dv;case 36296:return Lv;case 35678:case 36198:case 36298:case 36306:case 35682:return Nv;case 35679:case 36299:case 36307:return Uv;case 35680:case 36300:case 36308:case 36293:return Ov;case 36289:case 36303:case 36311:case 36292:return Fv}}class Bv{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=yv(t.type)}}class kv{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=zv(t.type)}}class jv{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let a=0,o=r.length;a!==o;++a){const l=r[a];l.setValue(e,t[l.id],i)}}}const ja=/(\w+)(\])?(\[|\.)?/g;function Zc(n,e){n.seq.push(e),n.map[e.id]=e}function Wv(n,e,t){const i=n.name,r=i.length;for(ja.lastIndex=0;;){const a=ja.exec(i),o=ja.lastIndex;let l=a[1];const d=a[2]==="]",c=a[3];if(d&&(l=l|0),c===void 0||c==="["&&o+2===r){Zc(t,c===void 0?new Bv(l,n,e):new kv(l,n,e));break}else{let h=t.map[l];h===void 0&&(h=new jv(l),Zc(t,h)),t=h}}}class Ms{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let o=0;o<i;++o){const l=e.getActiveUniform(t,o),d=e.getUniformLocation(t,l.name);Wv(l,d,this)}const r=[],a=[];for(const o of this.seq)o.type===e.SAMPLER_2D_SHADOW||o.type===e.SAMPLER_CUBE_SHADOW||o.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(o):a.push(o);r.length>0&&(this.seq=r.concat(a))}setValue(e,t,i,r){const a=this.map[t];a!==void 0&&a.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let a=0,o=t.length;a!==o;++a){const l=t[a],d=i[l.id];d.needsUpdate!==!1&&l.setValue(e,d.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,a=e.length;r!==a;++r){const o=e[r];o.id in t&&i.push(o)}return i}}function Jc(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const Hv=37297;let Gv=0;function Vv(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),a=Math.min(e+6,t.length);for(let o=r;o<a;o++){const l=o+1;i.push(`${l===e?">":" "} ${l}: ${t[o]}`)}return i.join(`
`)}const Qc=new He;function Xv(n){Je._getMatrix(Qc,Je.workingColorSpace,n);const e=`mat3( ${Qc.elements.map(t=>t.toFixed(4))} )`;switch(Je.getTransfer(n)){case Ps:return[e,"LinearTransferOETF"];case rt:return[e,"sRGBTransferOETF"];default:return je("WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function ed(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),a=(n.getShaderInfoLog(e)||"").trim();if(i&&a==="")return"";const o=/ERROR: 0:(\d+)/.exec(a);if(o){const l=parseInt(o[1]);return t.toUpperCase()+`

`+a+`

`+Vv(n.getShaderSource(e),l)}else return a}function qv(n,e){const t=Xv(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const Yv={[Sf]:"Linear",[_f]:"Reinhard",[Mf]:"Cineon",[Ef]:"ACESFilmic",[Tf]:"AgX",[Af]:"Neutral",[wf]:"Custom"};function $v(n,e){const t=Yv[e];return t===void 0?(je("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ds=new B;function Kv(){Je.getLuminanceCoefficients(ds);const n=ds.x.toFixed(4),e=ds.y.toFixed(4),t=ds.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Zv(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ar).join(`
`)}function Jv(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function Qv(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const a=n.getActiveAttrib(e,r),o=a.name;let l=1;a.type===n.FLOAT_MAT2&&(l=2),a.type===n.FLOAT_MAT3&&(l=3),a.type===n.FLOAT_MAT4&&(l=4),t[o]={type:a.type,location:n.getAttribLocation(e,o),locationSize:l}}return t}function ar(n){return n!==""}function td(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_SUN_LIGHTS/g,e.numSunLights).replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_SUN_LIGHT_SHADOWS/g,e.numSunLightShadows).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function nd(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const eb=/^[ \t]*#include +<([\w\d./]+)>/gm;function Go(n){return n.replace(eb,nb)}const tb=new Map;function nb(n,e){let t=Xe[e];if(t===void 0){const i=tb.get(e);if(i!==void 0)t=Xe[i],je('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return Go(t)}const ib=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function id(n){return n.replace(ib,rb)}function rb(n,e,t,i){let r="";for(let a=parseInt(e);a<parseInt(t);a++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return r}function rd(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}const sb={[xs]:"SHADOWMAP_TYPE_PCF",[sr]:"SHADOWMAP_TYPE_VSM"};function ab(n){return sb[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const ob={[hi]:"ENVMAP_TYPE_CUBE",[ki]:"ENVMAP_TYPE_CUBE",[Vs]:"ENVMAP_TYPE_CUBE_UV"};function lb(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":ob[n.envMapMode]||"ENVMAP_TYPE_CUBE"}const cb={[ki]:"ENVMAP_MODE_REFRACTION"};function db(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":cb[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}const fb={[il]:"ENVMAP_BLENDING_MULTIPLY",[Bm]:"ENVMAP_BLENDING_MIX",[km]:"ENVMAP_BLENDING_ADD"};function ub(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":fb[n.combine]||"ENVMAP_BLENDING_NONE"}function hb(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function pb(n,e,t,i){const r=n.getContext(),a=t.defines;let o=t.vertexShader,l=t.fragmentShader;const d=ab(t),c=lb(t),f=db(t),h=ub(t),u=hb(t),m=Zv(t),x=Jv(a),S=r.createProgram();let g,p,M=t.glslVersion?"#version "+t.glslVersion+`
